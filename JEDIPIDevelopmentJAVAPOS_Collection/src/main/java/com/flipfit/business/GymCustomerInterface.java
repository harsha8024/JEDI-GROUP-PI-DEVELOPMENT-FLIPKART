...
public interface GymCustomerInterface {
     ...
     * @param city the city
     */
    List<Gym> viewCenters(String city) throws InvalidInputException, GymNotFoundException;
     ...
     * @param date  the date
     */
    List<Slot> viewSlotsForGym(String gymId, LocalDate date) throws InvalidInputException, GymNotFoundException;
     ...
     * @throws InvalidInputException the invalid input exception
     */
    List<Booking> viewMyBookings(String userId) throws InvalidInputException;
}