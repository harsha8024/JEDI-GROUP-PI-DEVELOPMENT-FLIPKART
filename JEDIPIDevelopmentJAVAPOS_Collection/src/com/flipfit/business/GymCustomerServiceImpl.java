...
public class GymCustomerServiceImpl implements GymCustomerInterface {
    ...
    @Override
    public void viewCenters(String cityInput) throws InvalidInputException, GymNotFoundException {
    ...
    @Override
    public void viewSlotsForGym(String gymId, LocalDate date) throws InvalidInputException, GymNotFoundException {
    ...
    @Override
    public void viewMyBookings(String userId) throws InvalidInputException {
