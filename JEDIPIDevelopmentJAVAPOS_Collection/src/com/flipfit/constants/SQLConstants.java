...
public class SQLConstants {
    ...
    public static final String SELECT_APPROVED_GYM_OWNERS = "SELECT * FROM gym_owners WHERE is_active = 1";
    public static final String SELECT_PENDING_GYM_OWNERS = "SELECT * FROM gym_owners WHERE is_active = 0";
    ...
    public static final String SELECT_GYMS_BY_LOCATION = "SELECT * FROM gyms WHERE location = ? AND is_approved = 1";
    public static final String SELECT_APPROVED_GYMS = "SELECT * FROM gyms WHERE is_approved = 1";
    public static final String SELECT_PENDING_GYMS = "SELECT * FROM gyms WHERE is_approved = 0";
    public static final String UPDATE_GYM = "UPDATE gyms SET gym_name = ?, location = ?, is_approved = ? WHERE gym_id = ?";
    public static final String APPROVE_GYM = "UPDATE gyms SET is_approved = 1 WHERE gym_id = ?";
    ...
    public static final String SELECT_UNREAD_NOTIFICATIONS_BY_USER_ID = "SELECT * FROM notifications WHERE user_id = ? AND is_read = 0 ORDER BY created_at DESC";
    public static final String COUNT_UNREAD_NOTIFICATIONS = "SELECT COUNT(*) as count FROM notifications WHERE user_id = ? AND is_read = 0";
    public static final String MARK_NOTIFICATION_AS_READ = "UPDATE notifications SET is_read = 1 WHERE notification_id = ?";
    public static final String MARK_ALL_NOTIFICATIONS_AS_READ = "UPDATE notifications SET is_read = 1 WHERE user_id = ?";
    ...
    public static final String COUNT_PENDING_GYMS = "SELECT COUNT(*) as count FROM gyms WHERE is_approved = 0";
    public static final String COUNT_INACTIVE_GYM_OWNERS = "SELECT COUNT(*) as count FROM gym_owners WHERE is_active = 0";
}
